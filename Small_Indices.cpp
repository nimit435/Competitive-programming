...
//Code
ll func(vll& a, vll& b, ll i, ll fir, ll sec){
    if(i>= a.size()){
        return 0;
    }
    if(a[i]> (fir+sec) && b[i]>(fir+sec)){
        ll mx= max(a[i],b[i]);
        if(mx>=sec){
            fir= sec;
            sec= mx;
        ...
        return func(a,b, i+1, fir, sec);
    }
    else if(a[i]<= (fir+sec) && b[i]<=(fir+sec)){
        ll mx= max(a[i],b[i]);
        if(mx>=sec){
            fir= sec;
            sec= mx;
        ...
        if(mx<fir){
            ...
            ll a1= 0;
            if(mx>=sec){
                a1 =  max(a1, func(a, b, i+1, sec, mx)); 
            }
            else if(mx>=fir){
                a1 =  max(a1, func(a, b, i+1, fir, sec));
            }
            if(mn>=sec){
                a1 =  max(a1, 1+ func(a, b, i+1, sec, mn)); 
            }
            else if(mn>=fir){
                a1 =  max(a1, 1+ func(a, b, i+1, mn, sec));
            }
            else{
                a1= max(a1, 1+ func(a, b, i+1, fir, sec));
            }
            return a1;
        }
    }
