...
class Segtree{
    ...
    public:
        ...
        void set(ll i, ll v, ll x, ll lx, ll rx){
            ...
            maxs[x]= gcd(maxs[2*x+1], maxs[2*x+2]);
        }
        void set(ll i, ll v){
            set(i, v, 0, 0, size);
        }
        
        ll getgcd(ll l, ll r, ll x, ll lx, ll rx){
            if(l>=rx || r<=lx){
                // cout<<lx<<" "<<rx<<" "<<endl;
                return 0;
            }
            ...
            ll m= (lx+rx)/2;
            ll s1= getgcd(l,r, 2*x+1, lx, m);
            ll s2= getgcd(l, r, 2*x+2, m, rx);
            return gcd(s1,s2);
        }
