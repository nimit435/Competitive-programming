...
//Code
ll result(vll& perm, vll& ind, ll l, ll r, ll k, ll n){
    ll left = l; // ind[k]>=left
    ll right = r; // ind[k]<=right
    ll tot = 0;
    ll lessreq = 0;
    ll greatdisp = 0;
    ll greatreq = 0;
    ...
    // cout<<lessreq<<" "<<lessdisp<<" "<<greatreq<<" "<<greatdisp<<endl;
    return max(lessreq,lessdisp)+ max(greatreq,greatdisp);
    // return tot*2;
}
void solve() {
    ll n;
    ...
    fl(i,q){
        ...
        // result(perm, ind, l, r, k, n);
        cout<<result(perm, ind, l , r, k, n)<<" ";
    }
    cout<<endl;
