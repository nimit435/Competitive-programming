...
int func(vector<int>& arr, ll l, ll n){
    if(arr.size()==0){
        return n;
    }
    int lo= 0;
        ...
        for(int a=j; a>=0 && flag; a--){
            if(k&(1<<a)){
                ...
                if(!(vec[l]&(1<<a))){
                    ...
                    r= min(r, func(helper[a],l, n)-1);
                }
            }
            else{
                if(!fl2 && (vec[l]&(1<<a)) ){
                    if(func(helper[a],l, n)-1>r){
                        r= max(r, r2);
                        cout<<r+1<<" ";
                        flag= false;  
                    }   
