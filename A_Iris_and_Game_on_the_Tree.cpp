...
//Code
void Dfs(int i, int par, vector<ll>& leaves, vector<vll>& tree){
...
void solve() {
    ...
    ll res=0;
    if(st[1]!='?' || one_leaf!=zero_leaf){
        if(st[1]=='1'){
            res= zero_leaf+ ceil((double)unmarked_leaf/2);
        }
        else if(st[1]=='0'){
            res= one_leaf+ ceil((double)unmarked_leaf/2);
        }
        else if(one_leaf>zero_leaf){
            res= one_leaf+(unmarked_leaf/2);
        }
        else{
            res= zero_leaf +(unmarked_leaf/2);
        }
    }
