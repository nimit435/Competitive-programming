...
// 15 32 27 31 17 40 9 13 5 31 48 39 23 33 50 2 11 47 37 44 49 51 26 11 25 24 28 55 57 18 15 54 20 39 12 50 55 4 26 32 53 13 18 11 16 37 53 48 36 42 54 44 36 55 4 26 53 19 42
// Gerrymandering
...
void three(){
    if(interact(1,2)==interact(2,1)){
        resp(3);
        return;
    }
    else{
        if(interact(1,3)==interact(3,1)){
            resp(2);
            return;
        }
        else{
...
void solve() {
    ...
    for(int i=n; i>=1; i=i-2){
        if(i==3){
            ...
            if(interact(i,i-1)!= interact(i-1,i)){
                if(interact(1,i)!=interact(i,1)){
                    resp(i);
                    return;
                }
                else{
