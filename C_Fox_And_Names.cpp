...
//             }
//         }
//         TrieNode* getchil(int i){
//             return chil[i];
//         }
//         TrieNode* makechild(int i){
//             chil[i] = new TrieNode();
//             return chil[i];
//         }
//         TrieNode* toggle(){
...
//             TrieNode* temp = root;
//             fl(i,st.size()){
//                 if(temp->getchil(st[i]-'a')!= nullptr){
//                     if(ordering[st[i]-'a'] != -1 && ordering[st[i]-'a']<mxass-1){

//                         ispos = false;
//                     }
//                     temp = temp->getchil(st[i]-'a');
//                     if(i==st.size()-1){
//                         ispos = false;
//                     }
//                 }
//                 else if(!flag){
//                     flag = true;
//                     if(ordering[st[i]-'a']==-1){
//                         ordering[st[i]-'a'] = mxass;
//                         // cout<<mxass<<endl;
//                         mxass++;
//                     }
//                     else{
//                         fl(j,26){
//                             if(temp->getchil(j)!=nullptr){
//                                 if(ordering[j]>ordering[st[i]-'a']){
//                                     ispos = false;
//                                 }
//                             }
//                         }
//                     }
//                     temp = temp->makechild(st[i]-'a');
//                     if(i==st.size()-1){
//                         temp->toggle();
//                     }
//                 }
    ...
    for(int i=1; i<n; i++){
        fl(j, vec[i].size()){
            ...
            if(vec[i][j]!=vec[i-1][j]){ 
                graph[vec[i-1][j]-'a'].pb(vec[i][j]-'a');
                indeg[vec[i][j]-'a']++;
                break;
            }
